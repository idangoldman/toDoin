...
describe("Url html tag check", function() {
    it("Should be a valid url link", function() {
        expect(Blah.url.html('http://idan.com')).toBe('<a href="http://idan.com" target="_blank">idan.com</a>');
        expect(Blah.url.html('some thing to say: www.idan.com')).toBe('some thing to say: <a href="http://www.idan.com" target="_blank">idan.com</a>');
        expect(Blah.url.html('http://blah.co.il <- my old url.')).toBe('<a href="http://blah.co.il" target="_blank">blah.co.il</a> <- my old url.');
        expect(Blah.url.html('http://idan.com <- two urls -> http://leeya.com')).toBe('<a href="http://idan.com" target="_blank">idan.com</a> <- two urls -> <a href="http://leeya.com" target="_blank">leeya.com</a>');
    });
